...
import de.rakia.easyAbiturService.util.DateUtils;
...
public class Response <T> {
    ...
    public void addErrorMsgToResponse(String errorMsg, Exception ex) {
        de.rakia.easyAbiturService.dto.response.ResponseError error = new de.rakia.easyAbiturService.dto.response.ResponseError()
                .setDetails(errorMsg)
